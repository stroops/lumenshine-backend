...
var (
	snapshotColumns               = []string{"id", "asset_code", "issuer", "created_at", "updated_at", "updated_by"}
	snapshotColumnsWithoutDefault = []string{"asset_code", "issuer", "updated_by"}
	snapshotColumnsWithDefault    = []string{"id", "created_at", "updated_at"}
...
func (o *Snapshot) Dividends(mods ...qm.QueryMod) dividendQuery {
	...
	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"\"dividend\".*"})
	}
...
func (o *Snapshot) AddDividends(exec boil.Executor, insert bool, related ...*Dividend) error {
	...
	if o.R == nil {
		...
		o.R.Dividends = append(o.R.Dividends, related...)
	}
...
func FindSnapshot(exec boil.Executor, iD int, selectCols ...string) (*Snapshot, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from snapshot")
	}
...
func (o *Snapshot) Insert(exec boil.Executor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into snapshot")
	}
...
func (o SnapshotSlice) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"snapshot\" SET %s WHERE %s",
...
func (o *Snapshot) Delete(exec boil.Executor) (int64, error) {
	...
	sql := "DELETE FROM \"snapshot\" WHERE \"id\"=$1"
...
func (o SnapshotSlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	sql := "DELETE FROM \"snapshot\" WHERE " +
...
func SnapshotExists(exec boil.Executor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if snapshot exists")
	}
